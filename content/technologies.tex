...
\lstinputlisting[frame=single, caption=Ejemplo de código de Entity Framework]{content/code/entityframework.cs}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.50]{fig/openweathermap_logo}
