        ...
        static string detectUrl = "https://api.projectoxford.ai/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false";
        ...
        private async static Task<string> CheckUserIdentity()
        {
            ...
            JToken token = await postAndReturn(detectUrl, new DetectDataEntity("http://mirrorserverasmvc20160613125538.azurewebsites.net/Received/Stream.jpg"));
        ...
        private async static Task<JToken> postAndReturn(string url, object data)
        {
            ...
            client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", "45183365fcc74d6093f0ac011d7ba1ce");

            var serializedData = new StringContent(new JavaScriptSerializer().Serialize(data), Encoding.UTF8, "application/json");
